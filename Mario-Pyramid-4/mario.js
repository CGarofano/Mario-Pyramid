...
formElem.onsubmit = function(event) {
    ...
    // QUIZ
    // what happens if we don't do this?   - Spits out 404 error, not nice
    event.preventDefault();

    // QUIZ
    // what happens if we don't do this?    - Leaves behind the error message and red box, even if correct input is provided
    clearError();
    ...
    // TODO 1
    if (heightStr == "") {
        displayError("Please enter a height");
        return;
    }
